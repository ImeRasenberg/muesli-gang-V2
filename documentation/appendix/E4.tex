...
\subsection{Code 4.a$)$} \label{app:E4.a}
...
\subsection{Code 4.c$)$}\label{app:E4.b}
...
int main(){
	...
	for (int k=0; k< mc_steps; k++){
		...
		// printf("%i\n",displacement.disp);
		if(displacement.disp == 1){
			// printf("overlap found no displacement\n");
			continue; 
		}
		else if (displacement.disp == 0)
		{
			// printf("from: \t%f\t%f\t%f\n",Loaded_Data.r[displacement.index][0],
			//     Loaded_Data.r[displacement.index][1],Loaded_Data.r[displacement.index][2]);
			Loaded_Data.r[displacement.index][0] += displacement.d_r[0];
			Loaded_Data.r[displacement.index][1] += displacement.d_r[1];
			Loaded_Data.r[displacement.index][2] += displacement.d_r[2];
			
			for(int l=0; l<3;l++){
				float box_len = abs(Loaded_Data.box[l][0]-Loaded_Data.box[l][1]) ;
				
				if(Loaded_Data.r[displacement.index][l]<Loaded_Data.box[l][0]){
					Loaded_Data.r[displacement.index][l]+= box_len;
				}
				if(Loaded_Data.r[displacement.index][l]>Loaded_Data.box[l][1]){
					Loaded_Data.r[displacement.index][l] -= box_len;
				}
			}
			// printf("to: \t%f\t%f\t%f\n",Loaded_Data.r[displacement.index][0],
