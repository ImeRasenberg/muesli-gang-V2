...
We start of with the initial velocity from our Boltzman distribution and because of the low density and lack of forces the displacement is linear. This means that with a linear displacement the squared displacement is quadratic.
We do not get this linear displacement for the BM for any density because the random force is always present.
The higher density seems to be more linear because we do have interaction forces but is not linear when we try to fit it.
