...
Lastly we do not see the clear linear model for the MD simulation that we did see in the BM simulation where the 0.01 case in particular seems to be increasing on the entire time frame.
