...
In 1965 Gordon Moore postulated Moore's law, that the number of transistors on an integrated circuit doubles every 2 years \cite{4785860}. 
This law held for 50 years where the transistor count increased from 2308 to 58,2 billion \cite{owid-moores-law}. 
Recently the increase in transistors is slowing down and Moore's law is predicted to break for among other reasons, manufacturing and material limits, and the heat wall \cite{Markov_2014}.
...
Lastly the temperature is varied to study the stability of the skyrmions and whether they are topologically protected.
